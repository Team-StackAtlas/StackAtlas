...
export const SUBSTANCES: Substance[] = [
  ...
  },
  {
    id: 'tb-500',
    name: 'TB-500',
    description: 'A synthetic thymosin beta-4 fragment used in experimental recovery contexts for soft tissue and mobility support.',
    paths: [
      { domain: 'Body', category: 'Recovery' },
      { domain: 'Body', category: 'Strength & Muscle' },
      { domain: 'All', category: 'Novel' }
    ...
    classification: 'Frontier',
    administration: ['💉 Injectable'],
    averageDosage: '2-5mg weekly',
    lengthOfCycle: '4-8 weeks',
    mostPopularBrandId: 'b1',
    healthRisks: ['Unknown long-term effects', 'Quality and purity concerns'],
    subjectiveEffects: ['Soft tissue recovery', 'Mobility support'],
    toleranceBuildup: 'Unknown',
    possiblePairings: ['BPC-157'],
    riskLevel: 'Moderate',
  },
  {
    id: 'semaglutide',
